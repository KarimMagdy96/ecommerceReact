...
const apiCallResonse = [
  ...
  },
  {
    ...
    price: 168,
    description:
      "Satisfaction Guaranteed. Return or exchange any order within 30 days.\nDesigned and sold by Hafeez Center in the United States, shipped from the USA. Imported",
    category: "jewelery",
  ...
  },
  {
    ...
    price: 109,
    description:
      "3D NAND flash are applied to deliver high transfer speeds. Remarkable transfer speeds to improve work efficiency.",
    category: "electronics",
  ...
  },
  {
    ...
    price: 114,
    description:
      "Expand your PS4 gaming experience, Expand storage capacity up to 4TB",
    category: "electronics",
  ...
  },
  {
    ...
    price: 999.99,
    description:
      "49 INCH SUPER ULTRAWIDE 32:9 CURVED GAMING MONITOR with dual 27 inch screen side by side, Quantum dot (QLED) technology, HDR support, and factory calibration to ensure the most accurate and vivid colors",
    category: "electronics",
  ...
  },
  {
    ...
    price: 56.99,
    description:
      "Note:The Jackets is made according to the Asian figure, which is smaller than the European figure. Please choose a larger size.",
  ...
  },
  {
    ...
    price: 29.95,
    description:
      "100% POLYURETHANE (shell) 100% POLYESTER (lining) Imported Zipper closure Dry Clean Only",
    category: "women's clothing",
...
export const ProductProvider: React.FC<ProductProviderProps> = ({
  ...
  const getProducts = async () => {
    try {
      ...
      setProducts(apiCallResonse);
      setFilterProducts(apiCallResonse);
      console.error(error);
    }
  };
